...
import { HeartIcon, ShieldCheckIcon, ClockIcon, ArrowRightIcon } from '@heroicons/react/24/outline';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-blue-800 text-white">
        <div className="absolute inset-0">
          <img
            src="https://images.unsplash.com/photo-1576091160397-1f3c879a2076"
            alt="Health Insurance Hero"
            className="w-full h-full object-cover opacity-30"
          />
        </div>
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24 text-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold">Health Insurance</h1>
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900">Why Choose Our Health Insurance?</h2>
            <p className="mt-3 sm:mt-4 text-base sm:text-lg text-gray-600">
              Protect your health with plans tailored to your needs
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="flex flex-col justify-center">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                Our health insurance plans cover hospitalization, outpatient treatments, diagnostics, and critical illness care. With a network of over 5,000 hospitals, we ensure cashless treatment and quick claim processing. Choose from individual, family floater, or senior citizen plans to suit your lifestyle.
              </p>
              <NavLink
                to="#"
      ...
      <section className="py-12 sm:py-16 bg-blue-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 sm:mb-12">
            ...
            <p className="mt-3 sm:mt-4 text-base sm:text-lg text-gray-600">
              Comprehensive benefits for your peace of mind
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: 'Access over 5,000 hospitals for cashless treatment.',
              },
              {
                icon: ShieldCheckIcon,
                title: 'Critical Illness Cover',
                desc: 'Protection against major illnesses like cancer and heart disease.',
              },
              {
                icon: ClockIcon,
                title: 'Fast Claim Processing',
                desc: 'Hassle-free claims with quick approvals.',
              },
            ].map((feature, index) => (
